...
Route::get('/dimmas', function () {

    $pengajuan_detail = Pengajuan_detail::with('barang')->where('pengajuan_id', 159)->get();
    $pengajuan = Pengajuan::where('id', 159)->first();
    // $pengajuan_detail_first = Pengajuan_detail::with('barang')->where('pengajuan_id', 159)->first();
    // dd($pengajuan);
    $jsonNilai = array();
    ...
    return view('email', compact('pengajuan_detail', 'pengajuan', 'total'));
});
...
Route::get('/tes', [ApprovalController::class, 'tes'])->name('tes');
