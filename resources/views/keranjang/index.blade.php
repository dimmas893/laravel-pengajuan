        ...
        <div class="card-header">
                ...
                <div class="card-body">
                    <div class="row w-auto">
                        <div class="col-12">
                           <form action="{{ route('keranjang_store') }}" method="post">
                                @csrf
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($keranjang as $p)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ route('keranjang_delete', $p->id) }}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
