                            ...
                            <div class="card-header">Action</div>
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-6">
                                      ...
                                      @if($pengajuan->level_2 == null)
                                          ...
                                          {{-- <p>Rp {{ number_format($pengajuan->total_biaya,2,',','.') }}</p> --}}
                                              <form  id="approve" action="{{ route('approval_approve_superadmin') }}" style="display:none;" method="post">
                                                  @csrf
                                  ...
                                  <div class="col-6">
                                    <br>
                                    <a class="btn btn-success" href="{{ route('approval_approve_superadmin') }}"
                                    onclick="event.preventDefault(); document.getElementById('approve').submit();">approve
                                    </a>
