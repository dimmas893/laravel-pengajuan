                            ...
                            <div class="card-header">Action</div>
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-6">
                                      ...
                                      @if($pengajuan->level_1 == null)
                                          ...
                                          {{-- <p>Rp {{ number_format($pengajuan->total_biaya,2,',','.') }}</p> --}}
                                              <form id="approvedong" style="display:none" action="{{ route('approval_approve_admin') }}" method="post">
                                                  @csrf
                                  ...
                                  <div class="col-6">
                                    <a class="btn btn-success" href="{{route('approval_approve_admin')}}"
                                    onclick="event.preventDefault();
                                                document.getElementById('approvedong').submit();">
                                {{ __('Approve') }}
                            </a>
                                      <a href="{{ route('approval_admin') }}" class="btn btn-primary">Back</a>
                                  </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                  <div class="col-6">
                                      ...
                                      @if($pengajuan->level_1 == null)
                                          ...
                                          {{-- <p>Rp {{ number_format($pengajuan->total_biaya,2,',','.') }}</p> --}}
                                              <form id="approvedong"action="{{ route('approval_approve_admin') }}" style="display:none;" method="post">
                                                  @csrf
                                                  <input type="hidden" name="id" value="{{ $pengajuan->id }}">
                                                  <input type="submit" class="btn btn-success mb-5 text-center" value="Approve">
                                              </form>
                    ...
                    <div class="row mt-2 ml-2">
                        <div class="col">
                          <ul class="nav nav-tabs" role="tablist">
                            ...
                            @if($pengajuan->level_1)
                            <li class="nav-item">
                                <a class="nav-link active" href="#level_1" role="tab" data-toggle="tab">Approve Level 1</a>
                            </li>
                            @endif
                            @if($pengajuan->level_2)
                                <li class="nav-item">
                                  <a class="nav-link" href="#level_2" role="tab" data-toggle="tab">Approve Level 2</a>
                                </li>
                            @endif
        
                            @if($pengajuan->level_3)
                            <li class="nav-item">
                              <a class="nav-link" href="#level_3" role="tab" data-toggle="tab">Approve Level 3</a>
                            </li>
                            @endif
                          </ul>
                        ...
                        <div class="tab-content">
                          @if($pengajuan->level_1)
                            <div role="tabpanel" class="tab-pane fade in active show" id="level_1">
                              <div class="row">
                                  <div class="col-12">
                                      <div class="card mt-2">
                                          <div class="card-body"> 
                                              <div class="table-responsive">
                                                  <div>{{ $pengajuan->approve_level_1->name }}</div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                          ...
                          @endif
                          @if($pengajuan->level_2)
                              <div role="tabpanel" class="tab-pane fade in" id="level_2">
                                  <div class="row">
                                    <div class="col-12">
                                        <div class="card mt-2">
                                            <div class="card-body"> 
                                                <div class="table-responsive">
                                                    <div>{{ $pengajuan->approve_level_2->name }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                          ...
                          @endif
                          @if($pengajuan->level_3)
                            <div role="tabpanel" class="tab-pane fade in" id="level_3">
                                <div class="row">
                                  <div class="col-12">
                                      <div class="card mt-2">
                                          <div class="card-body"> 
                                              <div class="table-responsive">
                                                  <div>{{ $pengajuan->approve_level_3->name }}</div>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
